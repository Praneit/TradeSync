...
import { MOCK_INVOICES, CONCENTRATION_DATA } from '../../domesticConstants';
import { DeskHeader } from './DeskHeader';
import { getUnderwritingInsight } from '../../domesticServices/geminiService';
import { Invoice } from '../../domesticTypes';

export const ExporterAnalysisDesk: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <DeskHeader 
        title="Exporter Analysis Desk" 
        subtitle="Limited Exporter View / Compliance Check / Trade History"
