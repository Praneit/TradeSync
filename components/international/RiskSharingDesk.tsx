...
import { MOCK_INVOICES } from '../../domesticConstants';
import { Invoice } from '../../domesticTypes';

export const RiskSharingDesk: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <DeskHeader 
        title="Risk Sharing Desk" 
        subtitle="Co-Lending with Indian Banks / Risk Allocation / Settlement Coordination"
